<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FrmLogin.aspx.cs" Inherits="McSoftware.FrmLogin" %>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="txtUsuario">
                                    Usuario</label>
                                <asp:TextBox ID="txtLogin" MaxLength="25" runat="server" CssClass="form-control"  autocomplete="off" Text="45465030" />
                            </div>
                            <div class="form-group">
                                <label for="txtClave">
                                    Contraseña</label>
                                <asp:TextBox ID="txtPas" MaxLength="25" runat="server" CssClass="form-control"  TextMode="Password" autocomplete="off" />
                            </div>
